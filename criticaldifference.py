...
class CriticalDifference():
    ...
    def __init__(self):
        print('Critical Difference Object Created')
    ...
    def draw_cd_diagram(self, df_perf=None, alpha=0.05, title=None, labels=False):
        """
    ...
    def wilcoxon_holm(self, alpha=0.05, df_perf=None):
        ...
        friedman_p_value = friedmanchisquare(*(
            np.array(df_perf.loc[df_perf['model'] == c]['accuracy'])
        ...
        for i in range(m - 1):
            ...
            perf_1 = np.array(df_perf.loc[df_perf['model'] == classifier_1]['accuracy']
                              , dtype=np.float64)
